...
2. 気象情報の提供や、IBM の年次報告書の提供ができると回答されます。(Lab1のオプションを実施された方は、1つ目に「Blueworks Liveの価格を提供できる」と回答されます)  
![alt text](tool_images/image-94.png)
...
4. 以下のように入力し、**接続** をクリックします。 (XX は自身のイニシャル)  
**サーバー名:** XX_time_mcp  
...
6. MCPサーバーの管理のメニューが表示された場合は、右上の × で閉じます。
![alt text](tool_images/image-86.png)

7. 接続した Time MCP Server で利用できる外部ツールの一覧が表示されます。  
