...
5. 画面左上の **ツールの追加** アイコンをクリックし、**ツール**タブを選択します。検索ボックスに weather と入力し、表示された current weather for coordinates を **開始** と **終了** の間にドラッグ&ドロップします.  
...
![alt text](flow_images/image-5.png)  
...
![alt text](flow_images/image-8.png)  
...
2. **パラメーター**タブを開きます。**出力の追加** ボタンを押して**ストリング**を選択し、次の値を設定後、**完了** をクリックします。
    - 名前: temp_unit
    - 説明: tempが摂氏か華氏かを示す  
![alt text](flow_images/image-9.png)  

3. XX_weatherFlowの縦三点リーダーをクリックして表示されたメニューから **フロー・ビルダーで開く** をクリックします。  
![alt text](flow_images/image-10.png)  
...
7. 最初に追加した **コード・ブロック1** を編集します。
     ...
     3. 次の値を設定後、**追加** ボタンをクリックします。  
         - 名前: temp_unit   
         - 説明: tempが摂氏か華氏かを示す  
     ![alt text](flow_images/image-11.png)  
     ![alt text](flow_images/image-12.png)  
...
9. ブランチを編集します。
     ...
     2. **if**の右にある **+** ボタンをクリックし、表示されたセレクト変数において **入力** > **city_name** を選択します。  
     ![alt text](flow_images/flow_image0310.png)  
     ![alt text](flow_images/image-14.png)  
